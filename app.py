...
def main():
    ...
    if True:
        ...
        if subtitle_enabled:
            ...
            try:
                # This preview intentionally uses only the completed Blur Mask
                # result. It never renders subtitle styling or Background Blur.
                subtitle_test_source = st.session_state.get("blurred_video_path")
