...
def main():
    ...
    if True:
        ...
        if subtitle_enabled:
            ...
            try:
                # Prefer the completed Blur Mask frame. Before that file exists,
                # fall back to the uploaded source so the preview never vanishes.
                # It never renders subtitle styling or Background Blur.
                ...
                if subtitle_test_source:
                    ...
                    st.image(subtitle_test_frame, use_container_width=True)
