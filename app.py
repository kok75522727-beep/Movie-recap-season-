...
def main():
    ...
    if True:
        ...
        st.caption("Script → Effect → Blur → Voiceover + SRT → Logo + Subtitle → Video")
    ...
    if True:
        ...
        st.caption("အပေါ်က Platform၊ Effect၊ Logo၊ Voiceover နဲ့ မြန်မာစာတန်းထိုး ရွေးချယ်မှုအားလုံးပြီးမှ ဒီ Button ကိုနှိပ်ပါ။")
