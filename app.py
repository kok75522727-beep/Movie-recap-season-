        ...
        if subtitle_enabled:
            ...
            try:
                ...
                if subtitle_test_source:
                    ...
                    render_live_subtitle_browser_preview(subtitle_test_frame, subtitle_test_text, subtitle_font, subtitle_size, subtitle_text_color, subtitle_outline_color, subtitle_background_mode, subtitle_background_color, subtitle_background_opacity, subtitle_x, subtitle_y)
