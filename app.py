        ...
        with right:
            ...
            if video_duration:
                ...
                if source_kind == "Movie Recap":
                    st.info("နိုင်ငံခြား Recap လုပ်ပြီးသား Video ဖြစ်လို့ မူရင်းအရှည်အတိုင်း မြန်မာလိုပြန်လုပ်ပါမယ်။")
                else:
                    st.info("Simple Movie ဖြစ်လို့ ရိုးရိုး Movie/Scene ကို Video အရှည်အတိုင်း မြန်မာ Voiceover/SRT လုပ်ပါမယ်။")
            else:
                duration_seconds = 0
