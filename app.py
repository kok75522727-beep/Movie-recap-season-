...
def main():
    ...
    if True:
        ...
        with st.container(border=True):
            st.session_state.effect_freeze_bypass = st.checkbox("Freeze + Zoom Bypass", value=bool(st.session_state.get("effect_freeze_bypass", False)), key="effect-freeze-bypass", help="Final Video အစမှာ ခဏ Freeze လုပ်ပြီး Zoom အနည်းငယ်ထည့်ပေးမယ်")
    ...
    if True:
        ...
        if subtitle_enabled:
            ...
            with preview_hint:
                st.caption("စာတန်းနေရာချိန်ရန်သာ · Blur ကို Video ထုတ်မှပြမယ်")
